...
if __name__ == '__main__':
    ...
    print("".join(x[0] for x in output))
    print("".join(x[1] for x in output))

    print("".join(f"{x[0]}->{x[1]}" for x in output if x[0]!=x[1] and not any(xx=="-" for xx in x[:2])))
    print("".join(x[1] for x in output if x[0]!=x[1] and x[0]=="-"))
    print("".join(x[0] for x in output if x[0]!=x[1] and x[1]=="-"))
    print(output)
